...
////////////////////////////////////////////////////////////////////////////////
// PGNStickyView — like PGNGameView, but with sticky board + buttons
////////////////////////////////////////////////////////////////////////////////
...
class PGNStickyView{
  ...
  build(){
    ...
    let head=chess.header(),
        ...
        movetext=needs?M:(res?M+" "+res:M);

    // Sticky header block (title + board + buttons)
    ...
    // PGN under header (moves, comments, variations)
    this.parse(movetext);
  ...
  parseComment(text,i,ctx){
    ...
    // remove [D] inside comments, no diagrams
...
/* Sticky header + board + buttons as one block */
...
/* Buttons (centered under header block width) */
.pgn-sticky-buttons{
  display:flex;
