...
(function () {
  ...
  if (typeof Chess !== "function") {
    console.warn("pgn-guess.js: chess.js missing");
    return;
  }
  if (typeof Chessboard !== "function") {
    console.warn("pgn-guess.js: chessboard.js missing");
    return;
  }
  if (!window.PGNCore) {
    console.error("pgn-guess.js: PGNCore missing");
    return;
  }
  ...
  function safeChessboard(targetEl, options, tries = 30, onReady) {
    ...
    try {
      ...
      console.warn("pgn-guess.js: Chessboard init failed", err);
      return null;
    }
  }
  // --------------------------------------------------------------------------
  ...
  class ReaderPGNView {
    ...
    build() {
      ...
      this.headerDiv = this.wrapper.querySelector(".pgn-guess-header");
    ...
    gotoSpan(span) {
      ...
      const apply = () => {
        ...
        const container = this.wrapper.querySelector(".pgn-guess-right");
        if (container) {
